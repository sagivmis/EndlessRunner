...
namespace Cainos.PixelArtMonster_Dungeon
{
    public class MonsterFlyingController : MonoBehaviour
    {
        ...
        public float deadGravityScale = 1.0f;                           // gravity scale when the character is dead. it actually controls whether should the flying character fall to the ground when it is dead
