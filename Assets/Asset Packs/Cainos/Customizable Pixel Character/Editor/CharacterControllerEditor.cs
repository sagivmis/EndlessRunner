...
namespace Cainos
{
    ...
    public class CharacterControllerEditor : Editor
    {
        ...
        private SerializedProperty endlessRun;
        private SerializedProperty landEffect;
        private SerializedProperty runEffect;
        private SerializedProperty runEffectCooldown;
        private SerializedProperty runEffectTimer;
        ...
        private bool foldout_stats = true;
        ...
        private void OnEnable()
        {
            ...
            endlessRun = serializedObject.FindProperty("endlessRun");
            runEffect = serializedObject.FindProperty("runEffect");
            landEffect = serializedObject.FindProperty("landEffect");
            runEffectCooldown = serializedObject.FindProperty("runEffectCooldown");
            runEffectTimer = serializedObject.FindProperty("runEffectTimer");
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUI.indentLevel++;
                EditorGUILayout.PropertyField(runEffect);
                EditorGUILayout.PropertyField(landEffect);
                EditorGUI.indentLevel--;
            }
            foldout_stats = EditorGUILayout.Foldout(foldout_stats, "Stats", true);
            if (foldout_stats)
            {
                EditorGUI.indentLevel++;
                EditorGUILayout.PropertyField(runEffectCooldown);
                EditorGUILayout.PropertyField(runEffectTimer);
                EditorGUI.indentLevel--;
            }
            ...
            {
                EditorGUI.indentLevel++;
                EditorGUILayout.PropertyField(endlessRun);
